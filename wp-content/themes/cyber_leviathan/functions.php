...
function cl_enqueue(){
    ...
    wp_register_style('cl_customstyle', get_template_directory_uri().'/assets/customstyle.css');
    wp_register_style('cl_blogcustomstyle', get_template_directory_uri().'/assets/blogcustomstyle.css');
